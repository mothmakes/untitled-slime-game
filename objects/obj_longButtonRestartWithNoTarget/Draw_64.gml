...
else if(room == room_tutorial)
{
	...
	draw_text(display_get_gui_width()/2,140,"You can only access these stairs as the skeleton.");
	draw_text(display_get_gui_width()/2,200,"Make sure you don't kill it!");
